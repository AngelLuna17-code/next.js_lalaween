...
const Navbar = () => {
  ...
  return (
    <section>
      <nav ref={menuRef} className="top-0 py-4 px-6 lg:px-6 xl:px-8 text-white fixed top-0 w-screen z-30" style={{ background: 'rgba(0, 0, 0, 0.7)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
        <div className='flex justify-between items-center'>
          ...
          <div>
            ...
            {/* Burger button */}
            <div className="flex items-center space-x-10 hidden lg:block lg:flex">
              {/* Redes sociales */}
              <div className="flex items-center space-x-10 hidden lg:block lg:flex">                        <a href="https://www.facebook.com/LalaWeen/" target="blank">
                ...
                <a href="https://www.instagram.com/lala.ween/" target="blank">
                  <svg className='hover:text-[#00cac4]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <a href="https://www.tiktok.com/@lalaweencreativeteam" target="blank">
                  <svg className='hover:text-[#00cac4]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    <title>Enlace a Tiktok</title>
                    <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z" />
                  </svg>
                </a>
                <a href="mailto:CreativeTeam@LalaWeen.com" target="blank">
                  <svg className='hover:text-[#00cac4]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
